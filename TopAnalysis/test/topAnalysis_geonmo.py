...
def JetSecVtxProcess( jets, secvtxMassHist, secvtxMassHistB, secvtxMassHistC, secvtxMassHistL) :
    njets =0
    ntags = 0
    jets_p4 = [ ]
    ...
    return njets, ntags, jets_p4


def LeptonProcess( muons, electrons) :
    selectedMuons = [ ]
    selectedElectrons =[ ]
    numMuons     = 0
    numElectrons = 0 
    ...
    return selectedMuons, selectedElectrons, numMuons, numElectrons
...
metVsIso = ROOT.TH2F('metVsIso', 'MET Versus PFIsolation', 150, 0., 150., 400, 0., 4.0)
...
leadingMuonPt = ROOT.TH1F('muonPt',"Muon Pt", 100,0,100)
leadingMuonEta = ROOT.TH1F("muonEta","Muon Eta",50,-2.5,2.5)
leadingMuonPhi = ROOT.TH1F("muonPhi","Muon Phi",100,-3.1415,3.1415)
leadingJetPt =  ROOT.TH1F('lJetPt',"Leading Jet Pt", 100,0,100)
nJetsOnEnd = ROOT.TH1F('nJetsOnEnd','Number of Jets after selection',10,0,10)
...
for event in events:
    ...
    njets, ntags, jets_p4 = JetSecVtxProcess( jets, secvtxMassHist, secvtxMassHistB, secvtxMassHistC, secvtxMassHistL)
    ...
    #selectedMuons = []
    #selectedElectrons = []
    selectedMuons, selectedElectrons, numMuons, numElectrons = LeptonProcess( muons, electrons )
